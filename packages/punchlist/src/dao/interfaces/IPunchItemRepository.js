...
export interface IPunchItemRepository {
  ...
  getPunchItemsByAssigneeId(assigneeId: string, skip: ?number, limit: ?number,  assigneeId?: ?string, status?: ?PunchItemStatus, sort?: SortType): PunchItem[];
  getPunchItemsByStatus(status: PunchItemStatus, skip: ?number, limit: ?number,  assigneeId?: ?string, status?: ?PunchItemStatus, sort?: SortType): PunchItem[];
